...
class InfoAsyncAPI(BaseAsyncAPIClient):
    ...
    async def user_state(self, address: Optional[str] = None) -> Dict:
        ...
        requests = [
            # Account data
            {"method": "GET", "endpoint": "/api/v1/account", "params": {"account": address}},
            # Positions
            {"method": "GET", "endpoint": "/api/v1/positions", "params": {"account": address}},
            # Account settings (for custom leverage)
            {"method": "GET", "endpoint": "/api/v1/account/settings", "params": {"account": address}},
    ...
    async def user_funding(self, address: Optional[str] = None, start_time: int = 0) -> List[Dict]:
        ...
        try:
            response = await self.get("/api/v1/funding/history", params=params)
        except:
            response = {"data": []}
    ...
    async def meta(self) -> Dict:
        ...
        response = await self.get("/api/v1/info")
    ...
    async def all_mids(self) -> Dict:
        ...
        response = await self.get("/api/v1/info/prices")
    ...
    async def funding_rates(self) -> List[Dict]:
        ...
        try:
            response = await self.get("/api/v1/funding/rates")
        except:
            response = {"data": []}
    ...
    async def open_interest(self) -> Dict:
        ...
        try:
            response = await self.get("/api/v1/stats/open_interest")
        except:
            response = {"data": []}
